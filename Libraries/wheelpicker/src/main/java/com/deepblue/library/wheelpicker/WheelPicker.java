...
public class WheelPicker extends View implements IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        unitText = a.getString(R.styleable.WheelPicker_wheel_unit_text);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            //CaoJun
            String text = data;
            if (distanceToCenter == 0 && !TextUtils.isEmpty(unitText)) {
                text += unitText;
            }
            ...
            if (mSelectedItemTextColor != -1) {
                ...
                canvas.drawText(/*data*/text, mDrawnCenterX, drawnCenterY, mPaint);
                canvas.restore();
