...
//            particle[i] = Math.random() * ParticleCount
...
//
//            val point = points[i]
//            val colorR = (WaveColor[0] * point.y / height).toInt()
//            val colorG = (WaveColor[1] * point.y / height).toInt()
//            val colorB = (WaveColor[2] * point.y / height).toInt()
...
//
//        synchronized(this@ParticleWaveView) {
////            glPaint.color = Color.parseColor("#477CC2")
...
////            for (i in points.indices) {
////                val point = points[i]
////                KLog.d("onDraw", "$i : ${point.x} , ${point.y} , ${point.r}")
