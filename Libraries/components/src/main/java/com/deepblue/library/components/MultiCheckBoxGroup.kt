...
class MultiCheckBoxGroup : LinearLayout {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(if (widthMode == MeasureSpec.EXACTLY) widthSize else maxWidth,
    ...
    fun getChildCheckBoxAt(index: Int): CheckBox {
        return getChildAt(index) as CheckBox
    }
}
