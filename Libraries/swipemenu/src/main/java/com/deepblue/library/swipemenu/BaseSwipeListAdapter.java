package com.deepblue.library.swipemenu;
 ...
 * @date 2015/5/15
 */
public abstract class BaseSwipeListAdapter<T> extends BaseAdapter implements IAdapter<T> {
    ...
    public BaseSwipeListAdapter(@Nullable List<T> data, int viewTypeCount) {
        if (data == null) {
            data = new ArrayList<>();
        }
